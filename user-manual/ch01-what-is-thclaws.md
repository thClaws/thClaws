...
- **Multi-provider.** Anthropic (native + Claude Agent SDK via Claude
  ...
  THaLLE), OpenRouter, TokenRouter, Moonshot, xAI, Groq, MiniMax, Qwen Cloud, AtlasCloud, Unifically, Requesty, Meta, 9router, OpenCode Go, Azure AI Foundry, Ollama (local,
